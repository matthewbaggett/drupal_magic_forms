...
class SwitchMultiInputTest extends PHPUnit_Framework_TestCase {
    ...
    public function testSwitchMultiInput()
    {
        // Create a Salutation
        $new_field = magic_form_field_switch_multi::factory($this->input_default_name, $this->input_default_label);
